/**
 * Fantasy Premier League MCP Server - Cloudflare Workers Edition
 * HTTP-based MCP server for FPL data and team management
 */
...
export default {
  async fetch(request: Request, env: Env): Promise<Response> {
    ...
    if (url.pathname === "/" || url.pathname === "/health") {
      return new Response("FPL MCP Server - Cloudflare Workers Edition", {
